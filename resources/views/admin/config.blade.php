            ...
            <div class="card card-secondary card-outline">
              ...
              <form class="form-horizontal" action="{{ route('configs.store') }}" method="POST" >
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="slogan" class="col-sm-2 col-form-label">Business Slogan</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <label for="rp" class="col-sm-2 col-form-label">Return policy</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="rp" name="return_policy" value="{{ $cf->return_policy}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tn" class="col-sm-2 col-form-label">Tax Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="tn" name="default_tax_name" value="{{ $cf->default_tax_name }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tr" class="col-sm-2 col-form-label">Tax Rate</label>
                    <div class="col-sm-10">
